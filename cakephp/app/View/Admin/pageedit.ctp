...
<div class="container">
<form action="/storybridge/cakephp/admin/pageedit/<?php echo $storyId; ?>/<?php echo $pageNumber; ?>" id="PostAddForm" method="POST" accept-charset="utf-8" class="form-horizontal" role="form">
...
<input type="hidden" name="data[Page][page-number]" value="<?php echo $pageNumber;?>"/>
<div class="form-group"> 
   	<div class="col-md-6">
